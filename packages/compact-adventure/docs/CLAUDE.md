# Compact Adventure Package Guidelines
...
This is the root of LLM-targeted documentation for the Compact Adventure package. Every time you're activated, follow one of the provided workflows, depending on user's query. Each workflow should usually provide an atomic piece of work, committed to git.
...
7. **Create specific follow-up tasks** when appropriate:
   - "Clean up unused code from task COMPACT-XXX"
...
- Example: `feat(compact): add room descriptions for compact adventure`
