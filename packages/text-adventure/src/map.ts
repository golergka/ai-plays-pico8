    ...
    [RoomIds.mainHall]: {
      ...
      items: {
        [ItemIds.oldCoin]: {
          ...
          description:
            "A tarnished gold coin bearing ominous markings. Strange symbols pulse faintly in the torchlight. The dark runes suggest touching it without magical protection would be fatal.",
